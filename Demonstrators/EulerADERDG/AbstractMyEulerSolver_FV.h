...
//   www.exahype.eu
// ========================
#ifndef __AbstractMyEulerSolver_FV_CLASS_HEADER__
#define __AbstractMyEulerSolver_FV_CLASS_HEADER__
...
namespace EulerADERDG{
  class AbstractMyEulerSolver_FV;
  class MyEulerSolver_FV;
}

class EulerADERDG::AbstractMyEulerSolver_FV : public exahype::solvers::FiniteVolumesSolver, public exahype::solvers::UserFiniteVolumesSolverInterface  {
  public:
    ...
    static constexpr int PatchSize                 = 11;
...
#endif // __AbstractMyEulerSolver_FV_CLASS_HEADER__