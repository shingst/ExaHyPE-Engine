...
// =============================---==============
#ifndef __MyEulerSolver_FV_Variables_CLASS_HEADER__
#define __MyEulerSolver_FV_Variables_CLASS_HEADER__
 ...
 * specification file
 **/
struct EulerADERDG::AbstractMyEulerSolver_FV::VariableMetrics {
 ...
 **/
class EulerADERDG::AbstractMyEulerSolver_FV::VariableShortcuts : public EulerADERDG::AbstractMyEulerSolver_FV::VariableMetrics {
public:
 ...
 **/
class EulerADERDG::AbstractMyEulerSolver_FV::VariableMultiplicities : public EulerADERDG::AbstractMyEulerSolver_FV::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
 ...
 *
 **/
class EulerADERDG::AbstractMyEulerSolver_FV::VariableNames : public EulerADERDG::AbstractMyEulerSolver_FV::VariableMetrics {
public:
 ...
 * 
 *    void somewhere() {
 *       using namespace EulerADERDG::MyEulerSolver_FV_Variables::shortcuts;
 *       Q[foo] = 17;
 *    }
 *
 * instead of
 * 
 *    void somewhere() {
 *       EulerADERDG::AbstractMyEulerSolver_FV::VariableNames q;
 *       Q[q.foo] = 17;
 *    }
 *
 **/
namespace EulerADERDG {
  namespace MyEulerSolver_FV_Variables {
    namespace shortcuts {
      constexpr int rho = 0;
      constexpr int j = 1;
      constexpr int E = 4;
  ...
  } // end of namespace EulerADERDG::MyEulerSolver_FV_Variables 
...
class EulerADERDG::AbstractMyEulerSolver_FV::ReadOnlyVariables : public EulerADERDG::AbstractMyEulerSolver_FV::VariableMetrics {
  private:
...
class EulerADERDG::AbstractMyEulerSolver_FV::Variables : public EulerADERDG::AbstractMyEulerSolver_FV::VariableMetrics{
  private:
    double* _Q;
  public:
    static constexpr int SizeVariables  = 5;
...
class EulerADERDG::AbstractMyEulerSolver_FV::Fluxes : public EulerADERDG::AbstractMyEulerSolver_FV::VariableMetrics {
  private:
    double** _F;
  public:
