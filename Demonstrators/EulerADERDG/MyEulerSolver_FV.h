#ifndef __MyEulerSolver_FV_CLASS_HEADER__
#define __MyEulerSolver_FV_CLASS_HEADER__
...
class EulerADERDG::MyEulerSolver_FV : public EulerADERDG::AbstractMyEulerSolver_FV {
  private:
    /**
     * Log device
     */
  ...
  public:
    MyEulerSolver_FV(const double maximumMeshSize,const exahype::solvers::Solver::TimeStepping timeStepping);
...
#endif // __MyEulerSolver_FV_CLASS_HEADER__
