...
// =============================---==============
#ifndef __MyEulerSolver_ADERDG_Variables_CLASS_HEADER__
#define __MyEulerSolver_ADERDG_Variables_CLASS_HEADER__
 ...
 * specification file
 **/
struct EulerADERDG::AbstractMyEulerSolver_ADERDG::VariableMetrics {
 ...
 **/
class EulerADERDG::AbstractMyEulerSolver_ADERDG::VariableShortcuts : public EulerADERDG::AbstractMyEulerSolver_ADERDG::VariableMetrics {
public:
 ...
 **/
class EulerADERDG::AbstractMyEulerSolver_ADERDG::VariableMultiplicities : public EulerADERDG::AbstractMyEulerSolver_ADERDG::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
 ...
 *
 **/
class EulerADERDG::AbstractMyEulerSolver_ADERDG::VariableNames : public EulerADERDG::AbstractMyEulerSolver_ADERDG::VariableMetrics {
public:
 ...
 * 
 *    void somewhere() {
 *       using namespace EulerADERDG::MyEulerSolver_ADERDG_Variables::shortcuts;
 *       Q[foo] = 17;
 *    }
 *
 * instead of
 * 
 *    void somewhere() {
 *       EulerADERDG::AbstractMyEulerSolver_ADERDG::VariableNames q;
 *       Q[q.foo] = 17;
 *    }
 *
 **/
namespace EulerADERDG {
  namespace MyEulerSolver_ADERDG_Variables {
    namespace shortcuts {
      constexpr int rho = 0;
      constexpr int j = 1;
      constexpr int E = 4;
  ...
  } // end of namespace EulerADERDG::MyEulerSolver_ADERDG_Variables 
} // end of namespace EulerADERDG
...
class EulerADERDG::AbstractMyEulerSolver_ADERDG::ReadOnlyVariables : public EulerADERDG::AbstractMyEulerSolver_ADERDG::VariableMetrics {
  private:
...
class EulerADERDG::AbstractMyEulerSolver_ADERDG::Variables : public EulerADERDG::AbstractMyEulerSolver_ADERDG::VariableMetrics{
  private:
    double* _Q;
  public:
    static constexpr int SizeVariables  = 5;
...
class EulerADERDG::AbstractMyEulerSolver_ADERDG::Fluxes : public EulerADERDG::AbstractMyEulerSolver_ADERDG::VariableMetrics {
  private:
    double** _F;
  public:
