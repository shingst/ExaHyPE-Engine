 ...
 * specification file
 **/
struct EulerADERDG::AbstractMyEulerSolver::VariableMetrics {
 ...
 **/
class EulerADERDG::AbstractMyEulerSolver::VariableShortcuts : public EulerADERDG::AbstractMyEulerSolver::VariableMetrics {
public:
 ...
 **/
class EulerADERDG::AbstractMyEulerSolver::VariableMultiplicities : public EulerADERDG::AbstractMyEulerSolver::VariableMetrics {
public:
  /// positions of fields inside the unknown vector (solution vector) Q
 ...
 *
 **/
class EulerADERDG::AbstractMyEulerSolver::VariableNames : public EulerADERDG::AbstractMyEulerSolver::VariableMetrics {
public:
 ...
 * 
 *    void somewhere() {
 *       using namespace EulerADERDG::MyEulerSolver_Variables::shortcuts;
 *       Q[foo] = 17;
 *    }
 *
 * instead of
 * 
 *    void somewhere() {
 *       EulerADERDG::AbstractMyEulerSolver::VariableNames q;
 *       Q[q.foo] = 17;
 *    }
 *
 **/
namespace EulerADERDG {
  ...
  } // end of namespace EulerADERDG::MyEulerSolver_Variables 
...
class EulerADERDG::AbstractMyEulerSolver::ReadOnlyVariables : public EulerADERDG::AbstractMyEulerSolver::VariableMetrics {
  private:
...
class EulerADERDG::AbstractMyEulerSolver::Variables : public EulerADERDG::AbstractMyEulerSolver::VariableMetrics{
  private:
    double* _Q;
  public:
    static constexpr int SizeVariables  = 5;
...
class EulerADERDG::AbstractMyEulerSolver::Fluxes : public EulerADERDG::AbstractMyEulerSolver::VariableMetrics {
  private:
    double** _F;
  public:
