...
class EulerADERDG::AbstractMyEulerSolver: public exahype::solvers::ADERDGSolver {
  public:
    ...
    bool isPhysicallyAdmissible(
      ...
      const double t) const override { return true; }
    ...
    virtual void boundaryValues(const double* const x,const double t,const double dt,const int faceIndex,const int normalNonZero,const double* const fluxIn,const double* const stateIn,const double* const gradStateIn,double* const fluxOut,double* const stateOut) = 0;
