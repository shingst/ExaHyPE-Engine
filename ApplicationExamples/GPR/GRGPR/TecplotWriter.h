...
class GRGPR::TecplotWriter : public exahype::plotters::ADERDG2UserDefined {
 public:
 static constexpr int nVar = GRGPR::AbstractGPRSolver_ADERDG::NumberOfVariables;
 static constexpr int order = GRGPR::AbstractGPRSolver_ADERDG::Order;
 static constexpr int basisSize = order + 1;
   ...
   */
  TecplotWriter();
  TecplotWriter(GRGPR::GPRSolver_FV& solver);
  TecplotWriter(GRGPR::GPRSolver_ADERDG& solver);
  /**
