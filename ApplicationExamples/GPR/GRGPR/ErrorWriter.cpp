...
GRGPR::ErrorWriter::ErrorWriter() : exahype::plotters::ADERDG2UserDefined::ADERDG2UserDefined(),errors("output/error-"){
...
void GRGPR::ErrorWriter::plotPatch(
...
void GRGPR::ErrorWriter::startPlotting( double time) {
  // @TODO Please insert your code here.
  errors.startRow(time);
}


void GRGPR::ErrorWriter::finishPlotting() {
  // @TODO Please insert your code here.
  errors.finishRow();
}

void GRGPR::ErrorWriter::getNumericalSolution(double* numerical, double* u){
	getnumericalsolution_(numerical,u);
}

void GRGPR::ErrorWriter::getExactSolution(double* exact, double* pos, double timeStamp){
