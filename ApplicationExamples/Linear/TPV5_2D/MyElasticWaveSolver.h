...
class Elastic::MyElasticWaveSolver : public Elastic::AbstractMyElasticWaveSolver {
  private:
    ...
    //CurvilinearTransformation* transformation; // curvilinear transformation
  public:
    MyElasticWaveSolver(
    ...
    **/
    ...
    void extract_tractions(double sxx, double syy, double sxy, double* const n, double& Tx,double& Ty);
    void initialstresstensor(double& sxx, double& syy, double& sxy, double* const x);


    //rupture Dynamics

    void prestress(double& T0_n, double& T0_m, double* const x, double t, double* const m, double* const n);
