...
class Elastic::MyElasticWaveSolver : public Elastic::AbstractMyElasticWaveSolver {
  ...
  public:
    ...
    **/
    ...
    void riemannSolver(double* FL,double* FR,const double* const QL,const double* const QR,const double t,const double dt,const int normalNonZeroIndex, bool isBoundaryFace, int faceIndex) override;
    ...
    void extract_tractions(double sxx, double syy, double szz, double sxy, double sxz, double syz, double* n, double& Tx,double& Ty,double& Tz);
    void initialstresstensor(double& sxx, double& syy, double& szz, double& sxy, double& sxz, double& syz, double* x);
