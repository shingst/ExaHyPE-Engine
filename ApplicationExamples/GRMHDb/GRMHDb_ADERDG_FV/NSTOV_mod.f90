...
RECURSIVE SUBROUTINE NSTOV_x(r,NSTOV_q) 
...
RECURSIVE SUBROUTINE NSTOV_rbar(r,NSTOV_q) 
    USE Parameters, ONLY : EQN,NSTOVVar,NSTOVVar_barNew,NSTOVVar_bar,  NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_p_atmo, NSTOV_kappa, NSTOV_p_zero, NSTOV_nODE_p
    IMPLICIT NONE
    ! input argument 
    INTEGER,PARAMETER :: nVar=NSTOV_nODE 
...
RECURSIVE SUBROUTINE NSTOV_Main  
    USE Parameters, ONLY : EQN,NSTOVVar, NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_p_atmo, NSTOV_kappa, NSTOV_p_zero, NSTOV_nODE_p,NSTOVVar_bar,NSTOVVar_barNew
        USE NSTOV_modVar
        IMPLICIT NONE
        !
...
RECURSIVE SUBROUTINE NSTOV_solution(r,dr,q,printer) 
    USE Parameters, ONLY : EQN,NSTOVVar, NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_p_atmo, NSTOV_kappa, NSTOV_p_zero, NSTOV_nODE_p
    IMPLICIT NONE
...
RECURSIVE SUBROUTINE NSTOV_solution_rbar
    USE Parameters, ONLY : EQN,NSTOVVar,NSTOVVar_bar,NSTOVVar_barNew, NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_p_atmo, NSTOV_kappa, NSTOV_p_zero, NSTOV_nODE_p  
    IMPLICIT NONE
    ! local variables 
...
RECURSIVE SUBROUTINE NSTOV(eta,q) 
    USE Parameters, ONLY : EQN,NSTOVVar, NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_p_atmo, NSTOV_kappa, NSTOV_p_zero, NSTOV_nODE_p  
    ...
    NSTOV_p_atmo = NSTOVVar%p_R      !y(NSTOV_nODE_p,NSTOVVar%iradius)
    NSTOV_rho_atmo = NSTOVVar%rho_R  !(NSTOV_p_atmo/NSTOV_kappa)**igamma 
    !
END SUBROUTINE NSTOV
 


RECURSIVE SUBROUTINE NSTOV_ODESys(y,t,f)  
    USE Parameters, ONLY : EQN,NSTOVVar, NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_p_atmo, NSTOV_kappa, NSTOV_p_zero, NSTOV_nODE_p
    IMPLICIT NONE
