#ifndef __GRMHDbSolver_ADERDG_CLASS_HEADER__
#define __GRMHDbSolver_ADERDG_CLASS_HEADER__
...
class GRMHDb::GRMHDbSolver_ADERDG : public GRMHDb::AbstractGRMHDbSolver_ADERDG {
  private:
    /**
     * Log device
     */
...
/* multiplyMaterialParameterMatrix() not included, as requested in the specification file */
	...
	void mapDiscreteMaximumPrincipleObservables(
		double* const observables, const double* const Q) const override;
	/*	{
