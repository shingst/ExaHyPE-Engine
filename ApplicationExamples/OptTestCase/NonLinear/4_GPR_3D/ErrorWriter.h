...
class GPR::ErrorWriter : public exahype::plotters::ADERDG2UserDefined {
 public:
 static constexpr int nVar = GPR::AbstractGPRSolver_ADERDG::NumberOfVariables;
 static constexpr int order = GPR::AbstractGPRSolver_ADERDG::Order;
 static constexpr int basisSize = order + 1;
  ...
  ErrorWriter();
  ErrorWriter(GPR::GPRSolver_FV& solver);
  ErrorWriter(GPR::GPRSolver_ADERDG& solver);
