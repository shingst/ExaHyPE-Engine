...
class CCZ4::CCZ4Solver_ADERDG : public CCZ4::AbstractCCZ4Solver_ADERDG {
  ...
  public:
    CCZ4Solver_ADERDG(double maximumMeshSize,int maximumAdaptiveMeshDepth,int DMPObservables,int limiterHelperLayers,exahype::solvers::Solver::TimeStepping timeStepping);
