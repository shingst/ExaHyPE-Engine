...
RECURSIVE SUBROUTINE gaulag(x,w,alf)
    IMPLICIT NONE
    REAL, INTENT(IN) :: alf
...
RECURSIVE SUBROUTINE gaujac(x,w,n,alf,bet)
  !--------------------------------------------------------------------------
  INTEGER ::  n,MAXIT
...
RECURSIVE SUBROUTINE polint(xa,ya,x,y,dy)
...
RECURSIVE SUBROUTINE ratint(xa,ya,x,y,dy)
	IMPLICIT NONE
	REAL, DIMENSION(:), INTENT(IN) :: xa,ya
	REAL, INTENT(IN) :: x
	REAL, INTENT(OUT) :: y,dy
...
RECURSIVE SUBROUTINE svdcmp(a,w,v)
  !--------------------------------------------------------------------------
  !--------------------------------------------------------------------------
  IMPLICIT NONE
  !--------------------------------------------------------------------------
...
RECURSIVE SUBROUTINE splie2(x1a,x2a,ya,m,n,y2a)
  !--------------------------------------------------------------------------
  IMPLICIT NONE
  !--------------------------------------------------------------------------
  INTEGER                    :: j, k, m, n, NN
...
RECURSIVE SUBROUTINE splin2(x1a,x2a,ya,y2a,m,n,x1,x2,y)
  !--------------------------------------------------------------------------
  IMPLICIT NONE
  !--------------------------------------------------------------------------
  INTEGER                    :: j, k, m, n, NN
...
RECURSIVE SUBROUTINE spline(x,y,n,yp1,ypn,y2)
  !--------------------------------------------------------------------------
  IMPLICIT NONE
  !--------------------------------------------------------------------------      
  INTEGER                    :: i, k, n, NMAX
...
RECURSIVE SUBROUTINE splint(xa,ya,y2a,n,x,y)
  !--------------------------------------------------------------------------
  IMPLICIT NONE
  !--------------------------------------------------------------------------    
  INTEGER                    :: n,k,khi,klo
...
RECURSIVE SUBROUTINE hpsortr(n,ra) 
      INTEGER n
      REAL ra(n)
      INTEGER i,ir,j,l
      REAL rra
...
RECURSIVE SUBROUTINE hpsorti(n,ra) 
      INTEGER n
      INTEGER ra(n)
      INTEGER i,ir,j,l
      INTEGER rra
...
RECURSIVE SUBROUTINE hpsortia(n,m,ra) 
      INTEGER n,m
      INTEGER ra(m,n)
      INTEGER i,ir,j,l
      INTEGER rra(m) 
...
RECURSIVE SUBROUTINE gaussj(a,b)
    IMPLICIT NONE
    REAL, DIMENSION(:,:), INTENT(INOUT) :: a,b
...
RECURSIVE SUBROUTINE rg(nm,n,a,wr,wi,matz,z,iv1,fv1,ierr)
!
...
RECURSIVE SUBROUTINE balanc(nm,n,a,low,igh,scale)
!
...
RECURSIVE SUBROUTINE balbak(nm,n,low,igh,scale,m,z)
!
...
RECURSIVE SUBROUTINE cdiv(ar,ai,br,bi,cr,ci)
...
RECURSIVE SUBROUTINE elmhes(nm,n,low,igh,a,int)
!
...
RECURSIVE SUBROUTINE eltran(nm,n,low,igh,a,int,z)
!
...
RECURSIVE SUBROUTINE hqr(nm,n,low,igh,h,wr,wi,ierr)
...
RECURSIVE SUBROUTINE hqr2(nm,n,low,igh,h,wr,wi,z,ierr)
!
...
RECURSIVE SUBROUTINE indexx(n,arr,indx)
...
RECURSIVE SUBROUTINE golden(ax,bx,cx,f,tol,xmin,fmin)
