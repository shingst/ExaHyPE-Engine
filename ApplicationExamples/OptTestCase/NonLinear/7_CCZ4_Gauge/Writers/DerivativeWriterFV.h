...
//   www.exahype.eu
// ========================
#ifndef DerivativeWriterFV_CLASS_HEADER_
#define DerivativeWriterFV_CLASS_HEADER_

#include "exahype/plotters/FiniteVolumes2UserDefined.h"

namespace CCZ4 {
  class DerivativeWriterFV;
}

/**
 * The DerivativeWriterFV for all pure FiniteVolume solvers
 **/
class CCZ4::DerivativeWriterFV : public exahype::plotters::FiniteVolumes2UserDefined {
 public:
  /**
   * Constructor.
   * 
...
#endif /* DerivativeWriterFV_CLASS_HEADER_ */
