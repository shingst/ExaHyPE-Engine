...
CCZ4::DerivativeWriter::DerivativeWriter() :
...
void CCZ4::DerivativeWriter::plotPatch(
	...
	kernels::aderdg::generic::c::computeGradQ<CCZ4::AbstractCCZ4Solver_ADERDG>(gradQ, u, dx);
...
void CCZ4::DerivativeWriter::startPlotting( double time) {
	constraintReductions.startRow(time);
}


void CCZ4::DerivativeWriter::finishPlotting() {
