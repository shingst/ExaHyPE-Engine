...
void TOV::TOVSolver::TOV_C_Allocate()
{
  ...
  TOV_r_1d = new double[TOV_Num_Radial * TOV_Num_TOVs];
  ...
  TOV_m_1d = new double[TOV_Num_Radial * TOV_Num_TOVs];
  TOV_mbary_1d = new double[TOV_Num_Radial * TOV_Num_TOVs];
  TOV_rprop_1d = new double[TOV_Num_Radial * TOV_Num_TOVs];
}
