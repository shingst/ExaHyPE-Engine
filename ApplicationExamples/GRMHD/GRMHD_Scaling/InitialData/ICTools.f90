...
! this requires the -DRNSTOV preprocessor def.
...
MODULE NSTOV_mod
    ...
    REAL, PARAMETER :: tend_B = 50     ! Set the final radius here: sufficiently large   
    REAL, PARAMETER :: dt_B =0.001      ! Define the size of the time step 
...
SUBROUTINE NSTOV_x(r,NSTOV_q) 
    USE Parameters, ONLY : NSTOVVar, NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_kappa, NSTOV_p_atmo, NSTOV_nODE_p
    IMPLICIT NONE
    ! input argument 
...
SUBROUTINE NSTOV_rbar(r,NSTOV_q) 
    USE Parameters, ONLY : NSTOVVar,NSTOVVar_barNew,NSTOVVar_bar,  NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_kappa, NSTOV_p_atmo, NSTOV_nODE_p
    IMPLICIT NONE
    ! input argument 
    INTEGER,PARAMETER :: nVar=NSTOV_nODE 
...
SUBROUTINE NSTOV_Main  
    USE Parameters, ONLY : NSTOVVar, NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_kappa, NSTOV_p_atmo, NSTOV_nODE_p,NSTOVVar_bar,NSTOVVar_barNew
        USE NSTOV_modVar
        IMPLICIT NONE
        !
...
SUBROUTINE NSTOV_solution_rbar
    USE Parameters, ONLY : NSTOVVar,NSTOVVar_bar,NSTOVVar_barNew, NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_kappa, NSTOV_p_atmo, NSTOV_nODE_p  
    IMPLICIT NONE
    ! local variables 
...
SUBROUTINE NSTOV(eta,q) 
    USE Parameters, ONLY : gamma,NSTOVVar, NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_kappa, NSTOV_p_atmo, NSTOV_nODE_p  
    ...
    y0(NSTOV_nODE_p) = NSTOV_kappa*NSTOV_rho_c**gamma   ! P(0) = P(rhoc) polytropic EOS    !q3 
    !    t0_B = 0;           ! Initial time
...
SUBROUTINE NSTOV_ODESys(y,t,f)  
    USE Parameters, ONLY : PI,gamma,NSTOVVar, NSTOV_nODE, NSTOV_rho_c, NSTOV_rho_atmo, NSTOV_kappa, NSTOV_p_atmo, NSTOV_nODE_p
    IMPLICIT NONE
    ...
    !
    t2=t**2
    f(1) = 4.0*PI*(rhoh-p)*t2     
    f(2) = 4.0*PI*p*t2*t+q1
    den =t*(t -2.0*q1)
    f(2) = f(2)/den  
    f(3) = -rhoh*f(2)  
    !
