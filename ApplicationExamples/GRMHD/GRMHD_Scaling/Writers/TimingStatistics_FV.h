...
//   www.exahype.eu
// ========================
#ifndef TimingStatistics_FV_CLASS_HEADER_
#define TimingStatistics_FV_CLASS_HEADER_

#include "exahype/plotters/FiniteVolumes2UserDefined.h"

namespace GRMHD {
  class TimingStatistics_FV;
}

class TimingStatisticsWriter; // forward decl

class GRMHD::TimingStatistics_FV : public exahype::plotters::FiniteVolumes2UserDefined {
