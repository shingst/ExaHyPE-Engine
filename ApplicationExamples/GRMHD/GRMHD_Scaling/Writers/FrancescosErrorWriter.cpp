...
//   www.exahype.eu
// ========================
#include "Writers/FrancescosErrorWriter.h"
...
void GRMHD::FrancescosErrorWriter::plotPatch(
...
void GRMHD::FrancescosErrorWriter::startPlotting( double time) {
  // @TODO Please insert your code here.
  _timeStamp = time;
...
void GRMHD::FrancescosErrorWriter::finishPlotting() {
  constexpr int numberOfVariables = AbstractGRMHDbSolver_ADERDG::NumberOfVariables;
  ofstream myfile;
