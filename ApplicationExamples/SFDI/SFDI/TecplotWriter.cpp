...
SFDI::TecplotWriter::TecplotWriter() : exahype::plotters::LimitingADERDG2UserDefined::LimitingADERDG2UserDefined(){
  // @TODO Please insert your code here.
}

void SFDI::TecplotWriter::plotADERDGPatch(
...
void SFDI::TecplotWriter::plotFiniteVolumesPatch(
    const tarch::la::Vector<DIMENSIONS, double>& offsetOfPatch,
    const tarch::la::Vector<DIMENSIONS, double>& sizeOfPatch, double* const u,
    double timeStamp) {
  // @TODO Please insert your code here.
...
void SFDI::TecplotWriter::startPlotting( double time) {
  // @TODO Please insert your code here.
...
void SFDI::TecplotWriter::finishPlotting() {
  // @TODO Please insert your code here.
