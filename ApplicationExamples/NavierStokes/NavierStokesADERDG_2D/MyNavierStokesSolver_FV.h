#ifndef __MyNavierStokesSolver_FV_CLASS_HEADER__
#define __MyNavierStokesSolver_FV_CLASS_HEADER__
...
#include "AbstractMyNavierStokesSolver_FV.h"
...
namespace NavierStokesADERDG{
  class MyNavierStokesSolver_FV;
}

class NavierStokesADERDG::MyNavierStokesSolver_FV : public NavierStokesADERDG::AbstractMyNavierStokesSolver_FV {
  private:
    /**
     * Log device
     */
  ...
  public:
    MyNavierStokesSolver_FV(const double maximumMeshSize,const exahype::solvers::Solver::TimeStepping timeStepping);
...
#endif // __MyNavierStokesSolver_FV_CLASS_HEADER__
