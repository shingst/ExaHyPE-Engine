#ifndef __MyNavierStokesSolver_CLASS_HEADER__
#define __MyNavierStokesSolver_CLASS_HEADER__
...
#include "AbstractMyNavierStokesSolver.h"
...
namespace NavierStokesFV{
  class MyNavierStokesSolver;
}

class NavierStokesFV::MyNavierStokesSolver : public NavierStokesFV::AbstractMyNavierStokesSolver {
  private:
    /**
     * Log device
     */
  ...
  public:
    MyNavierStokesSolver(const double maximumMeshSize,const exahype::solvers::Solver::TimeStepping timeStepping);
     ...
     */
    void parabolicFlux(const double* const Q, double* gradQ, double** F) override;
...
#endif // __MyNavierStokesSolver_CLASS_HEADER__
