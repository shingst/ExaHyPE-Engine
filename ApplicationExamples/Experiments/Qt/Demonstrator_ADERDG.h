#ifndef __Demonstrator_ADERDG_CLASS_HEADER__
#define __Demonstrator_ADERDG_CLASS_HEADER__
...
#include "AbstractDemonstrator_ADERDG.h"
...
namespace Qt{
  class Demonstrator_ADERDG;
}

class Qt::Demonstrator_ADERDG : public Qt::AbstractDemonstrator_ADERDG {
  private:
    /**
     * Log device
     */
  ...
  public:
    Demonstrator_ADERDG(const double maximumMeshSize,const int maximumMeshDepth,const int haloCells,const int regularisedFineGridLevels,const exahype::solvers::Solver::TimeStepping timeStepping,const int limiterHelperLayers,const int DMPObservables);
...
#endif // __Demonstrator_ADERDG_CLASS_HEADER__
