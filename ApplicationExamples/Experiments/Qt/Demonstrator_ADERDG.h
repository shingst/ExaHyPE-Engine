...
class Qt::Demonstrator_ADERDG : public Qt::AbstractDemonstrator_ADERDG {
  ...
  public:
    Demonstrator_ADERDG(double maximumMeshSize,int maximumAdaptiveMeshDepth,int DMPObservables,int limiterHelperLayers,exahype::solvers::Solver::TimeStepping timeStepping);
