#ifndef __DummySolver_FV_CLASS_HEADER__
#define __DummySolver_FV_CLASS_HEADER__
...
#include "AbstractDummySolver_FV.h"
...
namespace HybridInterfaceDemonstration{
  class DummySolver_FV;
}

class HybridInterfaceDemonstration::DummySolver_FV : public HybridInterfaceDemonstration::AbstractDummySolver_FV {
  private:
    /**
     * Log device
     */
...
#endif // __DummySolver_FV_CLASS_HEADER__
