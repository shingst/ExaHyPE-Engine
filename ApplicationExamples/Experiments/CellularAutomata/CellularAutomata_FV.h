#ifndef __CellularAutomata_FV_CLASS_HEADER__
#define __CellularAutomata_FV_CLASS_HEADER__
...
namespace CA{
  class CellularAutomata_FV;
}

class CA::CellularAutomata_FV : public CA::AbstractCellularAutomata_FV {
  private:
    /**
     * Log device
     */
...
#endif // __CellularAutomata_FV_CLASS_HEADER__
