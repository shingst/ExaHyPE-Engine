#ifndef __EXAHYPE_PLOTTERS_MULTIPLEREDUCTIONSWRITER__
#define __EXAHYPE_PLOTTERS_MULTIPLEREDUCTIONSWRITER__
...
public:
	...
	MultipleReductionsWriter(
	  ...
	  const std::string _reductionsSuffix=".csv",
	...
	void add(int posq, const std::string& redname) {
		reductions.push_back(
			new exahype::plotters::ascii::ReductionsWriter(reductionsPrefix + redname, reductionsSuffix, strategy)
		);
