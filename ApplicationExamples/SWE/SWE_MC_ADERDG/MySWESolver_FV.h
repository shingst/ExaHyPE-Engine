...
class SWE::MySWESolver_FV : public SWE::AbstractMySWESolver_FV {
  ...
  public:
    ...
    double riemannSolver(double* const fL, double* const fR, const double* const qL, const double* const qR, const double* gradQL, const double* gradQR, const double* cellSize, int direction) override;
