...
class Elastodynamics::MyElastodynamicsSolver: public Elastodynamics::AbstractMyElastodynamicsSolver {
  ...
  public:
    ...
    void riemannSolver(double* FL,double* FR,const double* const QL,const double* const QR,double* tempFaceUnknownsArray,double** tempStateSizedVectors,double** tempStateSizedSquareMatrices,const double dt,const int normalNonZeroIndex,bool isBounaryFace) override;
