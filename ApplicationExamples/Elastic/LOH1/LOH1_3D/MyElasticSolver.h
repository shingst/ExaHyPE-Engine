...
class Elastic::MyElasticSolver: public exahype::solvers::ADERDGSolver {
  ...
  private:
    ...
    static void pointSources(double *luh,const tarch::la::Vector<DIMENSIONS,double>& center,const tarch::la::Vector<DIMENSIONS,double>& dx,double t,double dt, int nVar, int nParam, int _order);
};
