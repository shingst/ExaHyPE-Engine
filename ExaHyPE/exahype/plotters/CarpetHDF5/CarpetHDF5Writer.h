...
public:
  ...
  const exahype::parser::ParserView select; ///< A selection string for passing further parameters throught the ExaHyPE specification file.
   ...
   *
   **/
  CarpetHDF5Writer(const std::string& _filename, int _basisSize, int _solverUnknowns, int _writtenUnknowns, exahype::parser::ParserView _select,
