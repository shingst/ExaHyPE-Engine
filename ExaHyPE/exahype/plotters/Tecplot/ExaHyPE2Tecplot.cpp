...
void exahype::plotters::ExaHyPE2Tecplot::init(const std::string& filename, int orderPlusOne, int solverUnknowns, int writtenUnknowns, const std::string& select) {
...
void exahype::plotters::ExaHyPE2Tecplot::init(const std::string& filename, int basisSize, int solverUnknowns, int writtenUnknowns, const std::string& select) {
