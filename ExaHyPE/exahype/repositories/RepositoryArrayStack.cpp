...
exahype::repositories::RepositoryArrayStack::RepositoryArrayStack(
  ...
  _gridWithInitialPrediction(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset,_regularGridContainer,_traversalOrderOnTopLevel),
  ...
  _gridWithRefinementStatusSpreading(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset,_regularGridContainer,_traversalOrderOnTopLevel),
  ...
  _gridWithMergeNeighbours(_vertexStack,_cellStack,_geometry,_solverState,domainSize,domainOffset,_regularGridContainer,_traversalOrderOnTopLevel),
...
void exahype::repositories::RepositoryArrayStack::iterate(int numberOfIterations, bool exchangeBoundaryVertices) {
 ...
 void exahype::repositories::RepositoryArrayStack::switchToInitialPrediction() { _repositoryState.setAction(exahype::records::RepositoryState::UseAdapterInitialPrediction); }
 ...
 void exahype::repositories::RepositoryArrayStack::switchToRefinementStatusSpreading() { _repositoryState.setAction(exahype::records::RepositoryState::UseAdapterRefinementStatusSpreading); }
 ...
 void exahype::repositories::RepositoryArrayStack::switchToMergeNeighbours() { _repositoryState.setAction(exahype::records::RepositoryState::UseAdapterMergeNeighbours); }
 ...
 bool exahype::repositories::RepositoryArrayStack::isActiveAdapterInitialPrediction() const { return _repositoryState.getAction() == exahype::records::RepositoryState::UseAdapterInitialPrediction; }
 ...
 bool exahype::repositories::RepositoryArrayStack::isActiveAdapterRefinementStatusSpreading() const { return _repositoryState.getAction() == exahype::records::RepositoryState::UseAdapterRefinementStatusSpreading; }
 ...
 bool exahype::repositories::RepositoryArrayStack::isActiveAdapterMergeNeighbours() const { return _repositoryState.getAction() == exahype::records::RepositoryState::UseAdapterMergeNeighbours; }
