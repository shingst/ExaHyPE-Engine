...
#ifndef EXAHYPE_ADAPTERS_UniformRefinement_H_
#define EXAHYPE_ADAPTERS_UniformRefinement_H_
 ...
 */
class exahype::adapters::UniformRefinement {
  private:
    typedef mappings::UniformRefinement Mapping0;
    typedef mappings::LoadBalancing Mapping1;
    typedef mappings::LevelwiseAdjacencyBookkeeping Mapping2;

     Mapping0  _map2UniformRefinement;
