...
peano::CommunicationSpecification   exahype::adapters::UniformRefinement::communicationSpecification() const {
  return peano::CommunicationSpecification::getMinimalSpecification()
    &  _map2UniformRefinement.communicationSpecification()
...
peano::MappingSpecification   exahype::adapters::UniformRefinement::touchVertexLastTimeSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2UniformRefinement.touchVertexLastTimeSpecification(level)
...
peano::MappingSpecification   exahype::adapters::UniformRefinement::touchVertexFirstTimeSpecification(int level) const { 
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2UniformRefinement.touchVertexFirstTimeSpecification(level)
...
peano::MappingSpecification   exahype::adapters::UniformRefinement::enterCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2UniformRefinement.enterCellSpecification(level)
...
peano::MappingSpecification   exahype::adapters::UniformRefinement::leaveCellSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2UniformRefinement.leaveCellSpecification(level)
...
peano::MappingSpecification   exahype::adapters::UniformRefinement::ascendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2UniformRefinement.ascendSpecification(level)
...
peano::MappingSpecification   exahype::adapters::UniformRefinement::descendSpecification(int level) const {
  return peano::MappingSpecification::getMinimalSpecification()
    &  _map2UniformRefinement.descendSpecification(level)
...
exahype::adapters::UniformRefinement::UniformRefinement() {
}
...
exahype::adapters::UniformRefinement::UniformRefinement(const UniformRefinement&  masterThread):
  _map2UniformRefinement(masterThread._map2UniformRefinement) , 
...
void exahype::adapters::UniformRefinement::mergeWithWorkerThread(const UniformRefinement& workerThread) {
  _map2UniformRefinement.mergeWithWorkerThread(workerThread._map2UniformRefinement);
...
void exahype::adapters::UniformRefinement::createHangingVertex(
  ...
  _map2UniformRefinement.createHangingVertex(fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::UniformRefinement::destroyHangingVertex(
  ...
  _map2UniformRefinement.destroyHangingVertex(fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::UniformRefinement::createInnerVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
  ...
  _map2UniformRefinement.createInnerVertex(fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::UniformRefinement::createBoundaryVertex(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
  ...
  _map2UniformRefinement.createBoundaryVertex( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::UniformRefinement::destroyVertex(
      const exahype::Vertex&   fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
  ...
  _map2UniformRefinement.destroyVertex( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::UniformRefinement::createCell(
  ...
  _map2UniformRefinement.createCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::UniformRefinement::destroyCell(
  ...
  _map2UniformRefinement.destroyCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
#ifdef Parallel
void exahype::adapters::UniformRefinement::mergeWithNeighbour(
  ...
  int                                           level
   ...
   _map2UniformRefinement.mergeWithNeighbour( vertex, neighbour, fromRank, fineGridX, fineGridH, level );
...
void exahype::adapters::UniformRefinement::prepareSendToNeighbour(
  exahype::Vertex&  vertex,
  int                                           toRank,
  ...
  int                                           level
   ...
   _map2UniformRefinement.prepareSendToNeighbour( vertex, toRank, x, h, level );
...
void exahype::adapters::UniformRefinement::prepareCopyToRemoteNode(
  ...
  int                                           level
   ...
   _map2UniformRefinement.prepareCopyToRemoteNode( localVertex, toRank, x, h, level );
...
void exahype::adapters::UniformRefinement::prepareCopyToRemoteNode(
  exahype::Cell&  localCell,
   ...
   _map2UniformRefinement.prepareCopyToRemoteNode( localCell, toRank, x, h, level );
...
void exahype::adapters::UniformRefinement::mergeWithRemoteDataDueToForkOrJoin(
  exahype::Vertex&  localVertex,
  ...
  int                                       level
   ...
   _map2UniformRefinement.mergeWithRemoteDataDueToForkOrJoin( localVertex, masterOrWorkerVertex, fromRank, x, h, level );
...
void exahype::adapters::UniformRefinement::mergeWithRemoteDataDueToForkOrJoin(
  ...
  int                                       level
   ...
   _map2UniformRefinement.mergeWithRemoteDataDueToForkOrJoin( localCell, masterOrWorkerCell, fromRank, x, h, level );
...
bool exahype::adapters::UniformRefinement::prepareSendToWorker(
  exahype::Cell&                 fineGridCell,
  exahype::Vertex * const        fineGridVertices,
  const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
  exahype::Vertex * const        coarseGridVertices,
  ...
  bool result = false;
   result |= _map2UniformRefinement.prepareSendToWorker( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell, worker );
...
void exahype::adapters::UniformRefinement::prepareSendToMaster(
  exahype::Cell&                       localCell,
  ...
  const tarch::la::Vector<DIMENSIONS,int>&   fineGridPositionOfCell
   ...
   _map2UniformRefinement.prepareSendToMaster( localCell, vertices, verticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::UniformRefinement::mergeWithMaster(
  ...
  exahype::State&                masterState
   ...
   _map2UniformRefinement.mergeWithMaster( workerGridCell, workerGridVertices, workerEnumerator, fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell, worker, workerState, masterState );
...
void exahype::adapters::UniformRefinement::receiveDataFromMaster(
   ...
   _map2UniformRefinement.receiveDataFromMaster( receivedCell, receivedVertices, receivedVerticesEnumerator, receivedCoarseGridVertices, receivedCoarseGridVerticesEnumerator, receivedCoarseGridCell, workersCoarseGridVertices, workersCoarseGridVerticesEnumerator, workersCoarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::UniformRefinement::mergeWithWorker(
  exahype::Cell&           localCell, 
  ...
  int                                          level
   ...
   _map2UniformRefinement.mergeWithWorker( localCell, receivedMasterCell, cellCentre, cellSize, level );
...
void exahype::adapters::UniformRefinement::mergeWithWorker(
  ...
  int                                           level
   ...
   _map2UniformRefinement.mergeWithWorker( localVertex, receivedMasterVertex, x, h, level );
...
void exahype::adapters::UniformRefinement::touchVertexFirstTime(
      exahype::Vertex&               fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                          fineGridH,
      exahype::Vertex * const        coarseGridVertices,
  ...
  _map2UniformRefinement.touchVertexFirstTime( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::UniformRefinement::touchVertexLastTime(
      exahype::Vertex&         fineGridVertex,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridX,
      const tarch::la::Vector<DIMENSIONS,double>&                    fineGridH,
      exahype::Vertex * const  coarseGridVertices,
  ...
  _map2UniformRefinement.touchVertexLastTime( fineGridVertex, fineGridX, fineGridH, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfVertex );
...
void exahype::adapters::UniformRefinement::enterCell(
      exahype::Cell&                 fineGridCell,
      exahype::Vertex * const        fineGridVertices,
      const peano::grid::VertexEnumerator&                fineGridVerticesEnumerator,
      exahype::Vertex * const        coarseGridVertices,
  ...
  _map2UniformRefinement.enterCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::UniformRefinement::leaveCell(
      exahype::Cell&           fineGridCell,
      exahype::Vertex * const  fineGridVertices,
      const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
      exahype::Vertex * const  coarseGridVertices,
  ...
  _map2UniformRefinement.leaveCell( fineGridCell, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell, fineGridPositionOfCell );
...
void exahype::adapters::UniformRefinement::beginIteration(
  exahype::State&  solverState
) {
  _map2UniformRefinement.beginIteration( solverState );
...
void exahype::adapters::UniformRefinement::endIteration(
  exahype::State&  solverState
) {
  _map2UniformRefinement.endIteration( solverState );
...
void exahype::adapters::UniformRefinement::descend(
  ...
  _map2UniformRefinement.descend( fineGridCells, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell );
...
void exahype::adapters::UniformRefinement::ascend(
  exahype::Cell * const    fineGridCells,
  exahype::Vertex * const  fineGridVertices,
  const peano::grid::VertexEnumerator&          fineGridVerticesEnumerator,
  exahype::Vertex * const  coarseGridVertices,
  ...
  _map2UniformRefinement.ascend( fineGridCells, fineGridVertices, fineGridVerticesEnumerator, coarseGridVertices, coarseGridVerticesEnumerator, coarseGridCell );
