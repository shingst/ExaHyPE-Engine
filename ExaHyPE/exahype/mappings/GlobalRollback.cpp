 ...
 */
peano::CommunicationSpecification   exahype::mappings::GlobalRollback::communicationSpecification() const {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::GlobalRollback::touchVertexLastTimeSpecification(int level) const {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::GlobalRollback::touchVertexFirstTimeSpecification(int level) const { 
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::RunConcurrentlyOnFineGrid,true);
}
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::GlobalRollback::enterCellSpecification(int level) const {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::GlobalRollback::leaveCellSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidFineGridRaces,true);
}
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::GlobalRollback::ascendSpecification(int level) const {
 ...
 * @todo Please tailor the parameters to your mapping's properties.
 */
peano::MappingSpecification   exahype::mappings::GlobalRollback::descendSpecification(int level) const {
  return peano::MappingSpecification(peano::MappingSpecification::WholeTree,peano::MappingSpecification::AvoidCoarseGridRaces,true);
}


tarch::logging::Log                exahype::mappings::GlobalRollback::_log( "exahype::mappings::GlobalRollback" ); 


exahype::mappings::GlobalRollback::GlobalRollback() {
  logTraceIn( "GlobalRollback()" );
  // @todo Insert your code here
  logTraceOut( "GlobalRollback()" );
}
...
exahype::mappings::GlobalRollback::GlobalRollback(const GlobalRollback&  masterThread) {
  logTraceIn( "GlobalRollback(GlobalRollback)" );
  // @todo Insert your code here
  logTraceOut( "GlobalRollback(GlobalRollback)" );
}


void exahype::mappings::GlobalRollback::mergeWithWorkerThread(const GlobalRollback& workerThread) {
  logTraceIn( "mergeWithWorkerThread(GlobalRollback)" );
  // @todo Insert your code here
  logTraceOut( "mergeWithWorkerThread(GlobalRollback)" );
}
#endif
