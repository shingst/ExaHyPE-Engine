...
#ifndef EXAHYPE_MAPPINGS_Empty_H_
#define EXAHYPE_MAPPINGS_Empty_H_
...
class exahype::mappings::Empty {
  private:
    ...
    #ifdef USE_ITAC
    /**
     * A handle to measure the duration of an iteration.
     */
  ...
  public:
     ...
     * Controls.
     */
    static bool PerformReductions      ;
    static bool UseTouchVertexFirstTime;
    static bool UseLeaveCell           ;
    static bool UseEnterCell           ;
    ...
    /** Nop */
    Empty(const Empty& masterThread);
    #endif
    ...
    #if defined(SharedMemoryParallelisation)
    /** Nop */
    void mergeWithWorkerThread(const Empty& workerThread);
    #endif
