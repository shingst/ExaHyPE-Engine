...
void exahype::solvers::FiniteVolumesSolver::updateSolution(
  ...
  if (cellDescription.getTimeStepSize()>0) { // TODO(Dominic): is this if necessary?
					    solutionUpdate(solution,cellDescription.getOffset()+0.5*cellDescription.getSize(), cellDescription.getSize(),cellDescription.getTimeStamp(),cellDescription.getTimeStepSize(),admissibleTimeStepSize);
  }
