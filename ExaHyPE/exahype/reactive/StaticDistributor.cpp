...
void exahype::reactive::StaticDistributor::loadDistributionFromFile(const std::string& filename) {
...
void exahype::reactive::StaticDistributor::computeNewLoadDistribution(int enclaveCells, int skeletonCells) {
...
exahype::reactive::StaticDistributor& exahype::reactive::StaticDistributor::getInstance() {
  static StaticDistributor staticDist;
  return staticDist;
}

void exahype::reactive::StaticDistributor::resetRemainingTasksToOffload() {
...
void exahype::reactive::StaticDistributor::getAllVictimRanks(std::vector<int> &victims ) {
  int nnodes = tarch::parallel::Node::getInstance().getNumberOfNodes();
  for(int i=0; i<nnodes; i++) {
...
bool exahype::reactive::StaticDistributor::selectVictimRank(int& victim) {
