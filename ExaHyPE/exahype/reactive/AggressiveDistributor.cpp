...
void exahype::reactive::AggressiveDistributor::enable() {
  _isEnabled = true;
}

void exahype::reactive::AggressiveDistributor::disable() {
  _isEnabled = false;
}

void exahype::reactive::AggressiveDistributor::computeIdealLoadDistribution(int enclaveCells, int skeletonCells) {
...
exahype::reactive::AggressiveDistributor& exahype::reactive::AggressiveDistributor::getInstance() {
  static AggressiveDistributor aggressiveDist;
  return aggressiveDist;
}

void exahype::reactive::AggressiveDistributor::printOffloadingStatistics() {
  int nnodes = tarch::parallel::Node::getInstance().getNumberOfNodes();
  int myRank = tarch::parallel::Node::getInstance().getRank();
...
void exahype::reactive::AggressiveDistributor::resetRemainingTasksToOffload() {
...
void exahype::reactive::AggressiveDistributor::handleEmergencyOnRank(int rank) {
...
void exahype::reactive::AggressiveDistributor::updateLoadDistribution() {
...
bool exahype::reactive::AggressiveDistributor::selectVictimRank(int& victim) {
