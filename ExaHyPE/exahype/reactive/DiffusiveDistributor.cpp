...
void exahype::reactive::DiffusiveDistributor::updateZeroThreshold(int threshold) {
  _zeroThreshold = threshold;
}

void exahype::reactive::DiffusiveDistributor::updateLoadDistribution() {
  ...
  bool emergencyTriggered = exahype::reactive::OffloadingContext::getInstance().isEmergencyTriggered();
...
void exahype::reactive::DiffusiveDistributor::handleEmergencyOnRank(int rank) {
...
exahype::reactive::DiffusiveDistributor& exahype::reactive::DiffusiveDistributor::getInstance() {
  static DiffusiveDistributor diffusiveDist;
  return diffusiveDist;
}

bool exahype::reactive::DiffusiveDistributor::selectVictimRank(int& victim) {
