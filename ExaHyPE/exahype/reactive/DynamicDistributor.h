...
#if !defined(_EXAHYPE_OFFLOADING_DYNAMICDISTRIBUTOR_H_) && defined(SharedTBB)  && defined(Parallel)
#define _EXAHYPE_OFFLOADING_DYNAMICDISTRIBUTOR_H_
 ...
 */
class exahype::reactive::DynamicDistributor {
  private:
