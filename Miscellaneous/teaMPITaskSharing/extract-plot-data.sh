inputFiles=("./Output_base_two_nodes/results/Elastic-timestep-times.csv" "./Output_sharing_progress_thread_two_nodes/results/Elastic-timestep-times.csv" "./Output_sharing_server_bf_two_nodes/results/Elastic-timestep-times.csv"  "./Output_sharing_no_progress_two_nodes/results/Elastic-timestep-times.csv" "./Output_sharing_server_bf_two_nodes_handshake/results/Elastic-timestep-times.csv") 
outputFiles=("./plots/data_2_r_2_nodes_base"  "./plots/data_2_r_2_nodes_progression" "./plots/data_2_r_2_nodes_bluefield_direct"  "./plots/data_2_r_2_nodes_no_progression" "./plots/data_2_r_2_nodes_bluefield_handshake") 
