...
public class GenericLimiter implements Solver {
  ...
  public void writeHeader(java.io.BufferedWriter writer) throws IOException, IllegalArgumentException {
    throw new IllegalArgumentException("eu.exahype.solvers.GenericLimiter::writeHeader should not be called"); //No user implementation required
  }
  ...
  public void writeAbstractHeader(java.io.BufferedWriter writer) throws java.io.IOException, IllegalArgumentException {      
    final String template = IOUtils.convertRessourceContentToString("eu/exahype/solvers/templates/AbstractGenericLimiterSolverHeader.template");
  ...
  public void writeAbstractImplementation(java.io.BufferedWriter writer) throws java.io.IOException, IllegalArgumentException {
    final String template = IOUtils.convertRessourceContentToString("eu/exahype/solvers/templates/AbstractGenericLimiterSolverImplementation.template");
    writer.write(templateEngine.render(template, context));
  }
